...
NSString* FORGOT_PASSPHRASE_INFO_STRING() { return [OTRLanguageManager translatedString:@"Because the database contents is encrypted with your passphrase, you've lost access to your data and will need to delete and reinstall Glacier to continue. Password managers like 1Password or MiniKeePass can be helpful for generating and storing strong passwords."]; }
...
NSString* MANAGE_CHATSECURE_PUSH_ACCOUNT_STRING() { return [OTRLanguageManager translatedString:@"Manage Glacier Push account"]; }
