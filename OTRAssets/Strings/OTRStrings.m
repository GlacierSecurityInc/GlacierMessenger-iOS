...
NSString* ADD_BUDDY_STRING() { return [OTRLanguageManager translatedString:@"Add User"]; }
...
NSString* BUDDY_INFO_STRING() { return [OTRLanguageManager translatedString:@"User Info"]; }
...
NSString* CHATSECURE_PUSH_STRING() { return [OTRLanguageManager translatedString:@"Messages Push"]; }
/** "Messages", Title for chats view */
NSString* CHATS_STRING() { return [OTRLanguageManager translatedString:@"Messages"]; }
/** "Message", Title for chat view */
NSString* CHAT_STRING() { return [OTRLanguageManager translatedString:@"Message"]; }
...
NSString* CREATE_NEW_ACCOUNT_STRING() { return [OTRLanguageManager translatedString:@"Add Account"]; }
...
NSString* DELETE_CONVERSATIONS_ON_DISCONNECT_DESCRIPTION_STRING() { return [OTRLanguageManager translatedString:@"Delete messages on disconnect"]; }
...
/** "Because the database contents is encrypted with your passphrase, you've lost access to your data and will need to delete and reinstall Messenger to continue. Password managers like 1Password or MiniKeePass can be helpful for generating and storing strong passwords.", Text describing what happens when the user has forgotten the passphrase */
NSString* FORGOT_PASSPHRASE_INFO_STRING() { return [OTRLanguageManager translatedString:@"Because the database contents is encrypted with your passphrase, you've lost access to your data and will need to delete and reinstall Messenger to continue. Password managers like 1Password or MiniKeePass can be helpful for generating and storing strong passwords."]; }
...
NSString* GROUP_CHAT_STRING() { return [OTRLanguageManager translatedString:@"Group Msg"]; }
...
/** "Join Room", Text for joining existing XMPP room */
NSString* JOIN_GROUP_STRING() { return [OTRLanguageManager translatedString:@"Join Room"]; }
...
/** "Manage Messenger Push account", Title for button to manage ChatSecure Push account */
NSString* MANAGE_CHATSECURE_PUSH_ACCOUNT_STRING() { return [OTRLanguageManager translatedString:@"Manage Messenger Push account"]; }
...
NSString* OTRL_MSGEVENT_CONNECTION_ENDED_STRING() { return [OTRLanguageManager translatedString:@"Message has not been sent because other user has ended the private conversation. We should either close the connection, or refresh it."]; }
