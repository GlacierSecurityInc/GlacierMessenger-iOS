...
NSString *const RemoveGroupNotificationName = @"RemoveGroupNotificationName";
        ...
        if ([thread isKindOfClass:[OTRXMPPRoom class]]) {
            ...
            dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    [[NSNotificationCenter defaultCenter] postNotificationName:RemoveGroupNotificationName object:self userInfo:nil];
                });
            });
