...
typedef NS_ENUM(NSInteger, OTRNetworkConnectionStatus) {
    OTRNetworkConnectionStatusDisconnected = 0,
    OTRNetworkConnectionStatusUnknown,
    OTRNetworkConnectionStatusConnecting,
    OTRNetworkConnectionStatusConnected
};
