...
- (void) populateSettings
{
    ...
    resetPasswordSetting.actionBlock = ^void(id sender) {
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://console.glaciersec.cc/forget-password/"]];
    };
    ...
    privacyInfoSetting.actionBlock = ^void(id sender) {
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.glaciersecurity.com/privacy-policy/"] options:@{} completionHandler:nil];
    };
    ...
    supportSetting.actionBlock = ^void(id sender) {
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://glaciersecurity.zendesk.com"] options:@{} completionHandler:nil];
    };
