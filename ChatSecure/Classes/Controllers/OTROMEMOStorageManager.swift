...
open class OTROMEMOStorageManager {
    ...
    fileprivate func storeDevices(_ devices:[NSNumber], parentYapKey:String, parentYapCollection:String, transaction:YapDatabaseReadWriteTransaction) {
        ...
        if (devices.count == 0) {
            ...
            //just to help me understand what's happening
            //newDeviceSet = 3,4,5,6,7
            //previouslyStored = 1,2,3,4,5
            //devicesToRemove=1,2
            //devicesToAdd=6,7
            ...
            devicesToAdd.forEach({ (deviceId) in
                ...
                var trustLevel = OMEMOTrustLevel.trustedTofu //only since we are in a closed network
