...
public extension XMPPModule {
    ...
    func account(with transaction: YapDatabaseReadTransaction) -> OTRXMPPAccount? {
...
public extension XMPPMessageArchiveManagement {
    @objc func fetchHistory(archiveJID: XMPPJID? = nil, userJID: XMPPJID? = nil, since: Date? = nil) {
    ...
    @objc func fetchHistoryForThread(_ thread: OTRThreadOwner, transaction: YapDatabaseReadTransaction) {
