...
/** 
 Called when public group message is selected. No need to select buddies. Sends name for the group.
 */
- (void)enterPublicConversationWithName:(nonnull NSString *)name;
