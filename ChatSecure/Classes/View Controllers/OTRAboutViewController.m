...
- (void) setupImageView {
    self.imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"glaciersec" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil]];
...
- (void)viewDidLoad
{
    ...
    OTRAboutTableCellData *privacyInfo = [OTRAboutTableCellData cellDataWithTitle:@"Privacy Information" url:[NSURL URLWithString:@"https://www.glaciersecurity.com/privacy-policy/"]];
    OTRAboutTableCellData *termsOfUseInfo = [OTRAboutTableCellData cellDataWithTitle:@"Terms Of Use" url:[NSURL URLWithString:@"https://www.glaciersecurity.com/terms/"]];
    
    self.cellData = @[termsOfUseInfo,privacyInfo,aboutThisVersion];
...
- (void) updateViewConstraints {
    ...
    if (!self.hasAddedConstraints) {
        ...
        [self.aboutTableView autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:self.imageView];
...
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.glaciersecurity.com/"]];
}
