...
@property (nonatomic, strong, nullable) UIButton *attachButton;

@property (nonatomic, strong, nullable) UIButton *moreOptionsButton;
@property (nonatomic, strong, nullable) UIButton *hourglassButton;
...
- (void)setupPublicGroupWithName:(nullable NSString *)name;
