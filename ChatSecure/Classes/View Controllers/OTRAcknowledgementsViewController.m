...
- (void) setupHeaderView {
    CGRect headerFrame = CGRectMake(0, 0, 300, 185);
...
+ (instancetype)defaultAcknowledgementViewController
{
    ...
    NSString *chatSecureString =@"ChatSecure-iOS - 4.2";
    ...
    NSString *headerText = [NSString stringWithFormat:@"%@ - %@\n%@ - %@\n%@ - %@\n%@ - %@\n%@ - %@\n%@ - %@\n\n%@",libotrString,libotrVersionString,libgpgErrorString,libgpgErrorVersionString,libgcryptString,libgcryptVersionString,torString,torVersionString,openSSLString,openSSLVersionString,libEventString,libEventVersionString,chatSecureString];
    ...
    [headerLabel setText:headerText afterInheritingLabelAttributesAndConfiguringWithBlock:^NSMutableAttributedString *(NSMutableAttributedString *mutableAttributedString) {
        ...
        [mutableAttributedString addAttribute:NSFontAttributeName value:[UIFont boldSystemFontOfSize:17.0] range:[headerText rangeOfString:chatSecureString]];
        [mutableAttributedString addAttribute:NSLinkAttributeName value:@"https://chatsecure.org" range:[headerText rangeOfString:chatSecureString]];
