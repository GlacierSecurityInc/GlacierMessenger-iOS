...
// Log out button with Version button
- (void) createFooterStack {
    ...
    //UIImage *btnImage = [UIImage imageNamed:@"glacier_red_logout.png"];
...
-(void) doLogout:(id)sender {
    //run all this on a background thread while first pullingup the Cognito login page first
...
- (void) serverCheckUpdate:(NSNotification*)notification {
    if (![[OTRProtocolManager sharedInstance] isLoggingOut]) {
