...
open class OTRGroupAvatarGenerator {
    ...
    static let arrayOfImages:[UIImage] = [
        UIImage(named: "group1", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group2", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group3", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group4", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group5", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group6", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group7", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group8", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group9", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group10", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group11", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group12", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group13", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group14", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group15", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group16", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group17", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group18", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group19", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group20", in: OTRAssets.resourcesBundle, compatibleWith: nil)!,
        UIImage(named: "group21", in: OTRAssets.resourcesBundle, compatibleWith: nil)!
    ]
    ...
    public static func avatarImage(withSeedNum seedNum: Int, width: Int, height: Int) -> UIImage? {
        ...
        let ratio = size.width / imgwidth; //375 / 600
