...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.trashIconLabel.text = [NSString fa_stringForFontAwesomeIcon:FAIconTrash];
        ...
        self.microphoneIconLabel.text = [NSString fa_stringForFontAwesomeIcon:FAIconMicrophone];
