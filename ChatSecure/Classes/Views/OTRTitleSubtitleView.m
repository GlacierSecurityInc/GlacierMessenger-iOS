...
@property (nonatomic, strong) DGActivityIndicatorView *dynConnectingView; // connecting dots
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.dynConnectingView = [[[DGActivityIndicatorView alloc]
                                   ...
                                   tintColor:[UIColor blackColor] size:18.0f] initForAutoLayout];
...
- (void)setupContraints {
    ...
    [self.dynConnectingView autoMatchDimension:ALDimensionHeight toDimension:ALDimensionHeight ofView:self.titleImageView withMultiplier:1.0 relation:NSLayoutRelationLessThanOrEqual];
}
