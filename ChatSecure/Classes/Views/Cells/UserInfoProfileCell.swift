...
open class UserInfoProfileCell: XLFormBaseCell {
    ...
    open override func update() {
        ...
        setAppearance(userInfo: userInfo, displayNameLabel: displayNameLabel, avatarImageView: avatarImageView)
    }
...
extension UITableViewCell {
    func setAppearance(userInfo: OTRUserInfoProfile, displayNameLabel: UILabel, avatarImageView: UIImageView) { 
