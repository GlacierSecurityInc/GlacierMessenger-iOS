...
public extension OTRXMPPRoomOccupant {
     ...
     */
    @objc static func occupant(jid: XMPPJID?,
                               realJID: XMPPJID?,
                               roomJID: XMPPJID,
                               accountId: String,
                               createIfNeeded: Bool,
...
public extension OTRXMPPRoomOccupant {
    ...
    func canGrantAdmin(_ occupant:OTRXMPPRoomOccupant) -> Bool {
        return self.affiliation == .owner && (occupant.affiliation == .member || occupant.affiliation == .none)
    }

    func canRevokeMembership(_ occupant:OTRXMPPRoomOccupant) -> Bool {
    ...
    func canBan(_ occupant:OTRXMPPRoomOccupant) -> Bool {
