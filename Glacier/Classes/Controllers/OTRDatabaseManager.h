...
- (void)setDatabaseSalt:(NSData *)salt error:(NSError *_Nullable*)error;

- (void)setMediaDatabaseSalt:(NSData *)salt error:(NSError *_Nullable*)error;

- (BOOL) canSortDataView;
- (void) setCanSortDataView:(BOOL)sortDatabaseView;
- (void) resortDataView;
