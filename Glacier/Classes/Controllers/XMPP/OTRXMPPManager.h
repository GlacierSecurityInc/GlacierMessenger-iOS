...
@class XMPPPushModule, ServerCheck, FileTransferManager, MessageStorage, CallManager;
...
@property (nonatomic, strong, readonly) CallManager *callManager;
...
/** Will send an unavailable presence */
- (void) goOffline;
