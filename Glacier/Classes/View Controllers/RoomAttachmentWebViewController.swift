...
extension RoomAttachmentWebViewController: WKNavigationDelegate {
    ...
    public func webView(_ webView: WKWebView, decidePolicyFor navigationResponse: WKNavigationResponse,
        ...
        if navigationResponse.canShowMIMEType {
            ...
            let alert = UIAlertController(title: "Cannot Open", message: "Unable to open attachment", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction(title: NSLocalizedString("OK", comment: "OK button"), style: UIAlertActionStyle.default, handler: { (action: UIAlertAction) -> Void in
