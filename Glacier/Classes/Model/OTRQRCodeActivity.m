...
{
    return [UIImage otr_imageWithImage:[UIImage imageNamed:@"chatsecure_qrcode.png" inBundle:[GlacierInfo resourcesBundle] compatibleWithTraitCollection:nil] scaledToSize:[UIActivity otr_defaultImageSize]];
}
