...
public extension OMEMODevice {
    ...
    @objc func parent(with transaction: YapDatabaseReadTransaction) -> Any? {
        return transaction.object(forKey: parentKey, inCollection: parentCollection)
    }
    
    /// Checks if any of the devices are untrusted/new
    @objc static func filterNewDevices(_ devices: [OMEMODevice], transaction: YapDatabaseReadTransaction) -> [OMEMODevice] {
