...
@property (nonatomic, readonly) BOOL isMessageIncomingOrDifferentDevice;
@property (nonatomic, readonly) BOOL isSystemUpdate;
@property (nonatomic, readonly) BOOL isMarkable;
...
@property (nonatomic, readwrite) NSDate *messageReadDate;
@property (nonatomic, readwrite, nullable) NSString *messageText;
@property (nonatomic, readonly, nullable) NSString *messageOriginalText; //used with share location
@property (nonatomic, readonly, nullable) NSString *messageExpires;
...
/** Only applies to outgoing messages */
@property (nonatomic, readonly) BOOL isMessageDisplayed;
...
@property (nonatomic, strong, nonnull) NSDate *readDate;

@property (nonatomic, strong, nullable) NSString *text;
/** XMPP element id */
@property (nonatomic, strong, nullable) NSString *originalText; //used with share location
@property (nonatomic, strong, nullable) NSString *expires; 
@property (nonatomic, strong, nonnull) NSString *messageId;
@property (nonatomic, strong, nullable) NSError *error;
@property (nonatomic) BOOL systemUpdate;
@property (nonatomic) BOOL markable; 
