...
/** //OUTGOING ONLY. For MAM support */
@property (nonatomic, getter = isOutgoingFromDifferentDevice) BOOL outgoingFromDifferentDevice;

/** Mark message as deliverd via XEP-0184.*/
@property (nonatomic, getter = isDelivered) BOOL delivered;

/** Mark message as displayed via XEP-0333.*/ 
