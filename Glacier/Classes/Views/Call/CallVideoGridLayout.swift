...
protocol CallVideoGridLayoutDelegate: class {
...
class CallVideoGridLayout: UICollectionViewLayout {

    public weak var delegate: CallVideoGridLayoutDelegate?
    ...
    override func prepare() {
        ...
        guard let (numberOfRows, numberOfColumns) = possibleGrids.first else {
            return //return owsFailDebug("missing grid")
        }

        let totalViewWidth = delegate.width
        let totalViewHeight = delegate.height
